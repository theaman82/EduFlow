        ...
        <form action="actions/registerAction.php" method="post" class="p-8 flex flex-col gap-3 rounded shadow-2xl text-white bg-[#11999E]">
            ...
            <div class="grid grid-cols-2 gap-2">
                <div class="flex flex-col gap-2">
                    ...
                    <input type="text" name="first_name" id="" class="border text-black p-2 rounded outline-none">
                </div>
                <div class="flex flex-col gap-2">
                    <label for="" class="text-lg font-semibold">Last Name :-</label>
                    <input type="text" name="last_name" id="" class="border text-black p-2 rounded outline-none">
                </div>
            </div>
            <div class="flex flex-col gap-2">
